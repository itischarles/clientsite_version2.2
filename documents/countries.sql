...
CREATE TABLE `countries_list` (
  ...
  `country_alpha_2` varchar(2) NOT NULL default '',
  `country_alpha_3` varchar(3) NOT NULL default '',
  PRIMARY KEY  (`countryID`)
) ;

INSERT INTO `countries_list` (`country_name`, `country_alpha_2`, `country_alpha_3`) VALUES
    ('Afghanistan', 'af', 'afg'),
